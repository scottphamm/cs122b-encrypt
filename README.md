...
### To run this example: 
1. clone this repository using `git clone https://github.com/UCI-Chenli-teaching/cs122b-fall21-project3-encryption-example.git`
...
1. clone this repository using `git clone https://github.com/UCI-Chenli-teaching/cs122b-fall21-project3-encryption-example.git`
2. `cd cs122b-fall21-project3-encryption-example`
